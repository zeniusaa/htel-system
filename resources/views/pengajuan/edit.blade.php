<x-app-layout>
    ...
    <div class="py-8 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <form method="POST" action="{{ route('pengajuan.update', $pengajuan->id) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input name="nama_debitur" value="{{ old('nama_debitur', $pengajuan->nama_debitur) }}"
                    ...
                    <div>
                        ...
                        <input name="nik" value="{{ old('nik', $pengajuan->nik) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir"
                            value="{{ old('tanggal_lahir', $pengajuan->tanggal_lahir) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="pekerjaan" value="{{ old('pekerjaan', $pengajuan->pekerjaan) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat" rows="3"
                            ...
                            required>{{ old('alamat', $pengajuan->alamat) }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select name="jenis_hak"
                            ...
                            required>
                            <option value="SHM"
                                {{ old('jenis_hak', $pengajuan->jenis_hak) === 'SHM' ? 'selected' : '' }}>
                                SHM (Sertifikat Hak Milik)
                            </option>
                            <option value="SHGB"
                                {{ old('jenis_hak', $pengajuan->jenis_hak) === 'SHGB' ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input name="no_sertifikat" value="{{ old('no_sertifikat', $pengajuan->no_sertifikat) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    ...
                    <div>
                        ...
                        <input name="pemilik_sertifikat"
                            value="{{ old('pemilik_sertifikat', $pengajuan->pemilik_sertifikat) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="kantor_pertanahan"
                            value="{{ old('kantor_pertanahan', $pengajuan->kantor_pertanahan) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    ...
                    <div>
                        ...
                        <input name="desa" value="{{ old('desa', $pengajuan->desa) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="kecamatan" value="{{ old('kecamatan', $pengajuan->kecamatan) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="kota" value="{{ old('kota', $pengajuan->kota) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="provinsi" value="{{ old('provinsi', $pengajuan->provinsi) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input name="no_apht" value="{{ old('no_apht', $pengajuan->no_apht) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_apht"
                            value="{{ old('tanggal_apht', $pengajuan->tanggal_apht) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="peringkat_apht" value="{{ old('peringkat_apht', $pengajuan->peringkat_apht) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="nominal_display"
                            value="Rp {{ number_format(old('nominal', $pengajuan->nominal), 0, ',', '.') }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#00A39D] focus:border-transparent"
