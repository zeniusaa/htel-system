...
<!-- Halaman Pengajuan PPAT -->
    ...
    <div class="py-8 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        @php
            ...
            $dokumenWajib = ['AKAD', 'APHT', 'SPA', 'KTP', 'SERTIFIKAT'];
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <!-- <span class="text-sm font-semibold text-gray-800">{{ $jenis }}</span> -->
                             <span class="text-sm font-semibold text-gray-800">
                                {{ $jenis }}
                                @if(in_array($jenis, $dokumenWajib))
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @if ($sps)
                            <iframe src="{{ Storage::url($sps->file_path) }}" class="w-full h-96 border rounded">
                            </iframe>
                        @else
                            <div
        ...
        @if ($sht)
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
                ...
                <div class="p-6 space-y-4">
                    <iframe src="{{ Storage::url($sht->file_path) }}" class="w-full h-96 border rounded mb-4">
                    </iframe>
        ...
        <div id="modal-{{ $d->id }}"
            ...
            <div class="bg-white w-full max-w-4xl h-[80vh] rounded-xl shadow-2xl flex flex-col overflow-hidden">
                ...
                <div class="flex-1 p-4">
                    <iframe src="{{ Storage::url($d->file_path) }}" class="w-full h-full border"></iframe>
                    </iframe>
                </div>
